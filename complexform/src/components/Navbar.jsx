...
const Navbar = () => {
  ...
  return (
    <Box sx={{ position:"relative" , mx:"auto"}}>
      ...
      <AppBar position="static" sx={{backgroundColor:"transparent", boxShadow: 'none' ,height:"60px" , zIndex:2 }}>
        <Toolbar sx={{maxWidth:"1200px",   mx:"auto" , display:"flex" , justifyContent:"space-b:etween", alignItems:"center",gap:28}}>
          ...
          <Box sx={{ display: { xs: 'none', md: 'inline-flex' } ,alignItems:"center" ,gap:2}}>
            ...
            <Button sx={{color:activeState === "howitworks"? "#813013":"#2C66B8"}} onClick={()=>setActiveState("howitworks")}>HOW IT WORKS</Button>
            <IconButton sx={{color:activeState === "search" ? "#813013":"#2C66B8" }}onClick={()=>setActiveState("search")} >
            <SearchIcon/>
            </IconButton>
           <Button variant='contained' sx={{   zIndex: 2,}}>LOGIN</Button>
          </Box>
